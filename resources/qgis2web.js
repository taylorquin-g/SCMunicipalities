...
map.getView().fit([-10059551.613454, 4157008.420977, -9970199.872029, 4228002.994187], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Municipalities of Shelby County, TN</h2>';
        return titleElement;
    })(),
